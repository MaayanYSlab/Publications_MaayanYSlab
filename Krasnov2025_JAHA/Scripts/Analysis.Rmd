...
```{r}
data = readRDS(paste(wd,'/Helena_data_Temp_stroke.rds'))
...
# demographics
```{r}
df <- read_excel(paste(wd,"/MSD-2117.xlsx"))
...
# Median min temp 9.15
# Median duirnal temp 7.99
tiff(paste(wd,"/MI_comulative.tif",res=300,width=7,height=10,unit="in"))
...
```{r}
tiff(paste(wd,"/MI_lags_with_title.tif",res=300,width=15,height=15,unit="in"))
...
folder_path <- "/Daily Ozone EPA"  # <-- Replace this with your folder path
