...
#Load exposure file
```{r}
data = readRDS(paste(wd,'/exposures.rds'))
summary(data$date)
summary(data$pm25)
#Event year
...
df_events <- read_excel(paste(wd,"C/MSD-1332_Final_Resultset.xlsx", sheet = "Primary admissions"))


df_sociodem = read_excel(paste(wd,"/MSD-1332_Final_Resultset.xlsx", sheet = "sociodemogrhic"))
...
data3 = saveRDS(paste(wd,'/Helena_data_Temp_stroke.rds'))
```
